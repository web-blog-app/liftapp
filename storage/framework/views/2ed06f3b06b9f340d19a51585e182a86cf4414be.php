...
<table class="table  table-hover" >
  ...
  <tbody>
    ...
    <tr>
      <td class="data"><?php echo e(Carbon\Carbon::parse($lift ->date)->format('d.m.Y ')); ?></td>
      <td class="address"><?php echo e($lift ->address); ?>-<?php echo e($lift ->front); ?>-<?php echo e($lift ->typeOfLift); ?></td>      
      <td class=typeError><?php echo e($lift ->typeOfError); ?></td>  
      <td class="notice"><?php echo e($lift ->notice); ?></td>
