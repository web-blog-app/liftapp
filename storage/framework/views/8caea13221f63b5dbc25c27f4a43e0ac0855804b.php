...
<div class="notice">
     <a class="btn  color_but_blue " data-toggle="collapse" href="#collapseExample<?php echo e($lift -> id); ?>a" role="button" aria-expanded="true" aria-controls="collapseExample">№ ошибки:
  </a>
  <a class="btn  color_but_blue" data-toggle="collapse" href="#collapseExample<?php echo e($lift -> id); ?>" role="button" aria-expanded="false" aria-controls="collapseExample">
    Заметка механника: 
  </a>
 </div> 
<div class="collapse" id="collapseExample<?php echo e($lift -> id); ?>">
  <div class="card card-body">
    <span><?php echo e($lift -> notice); ?></span>
  </div>
</div>
<div class="collapse" id="collapseExample<?php echo e($lift -> id); ?>a">
  <div class="card card-body">
    <span><?php echo e($lift -> typeOfError); ?></span>
  </div>
</div>
