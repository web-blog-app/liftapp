      ...
      <div class="drop-container">
        ...
        <div class="collapse" id="collapseExample">
            <div class="card card-body">
              <form class="drop-form" method="get" action="<?php echo e(route('searchLift')); ?>">
        ...
        <div class="table-responsive-sm">
          <table class="table  table-hover" >
            ...
            <tbody>
            <?php $__currentLoopData = $lifterrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
