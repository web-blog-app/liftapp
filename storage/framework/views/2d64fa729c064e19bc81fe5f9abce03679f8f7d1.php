             ...
             onclick="event.preventDefault();
               document.getElementById('logout-form').submit();">
                ...
                <div class="menu-items">
                     <?php if(Auth::user()->role_id == '2'|'1'): ?>
                    <ul>
                        <li><a href="/liftapp/public/" class="fadeInUp animated">
                        ...
                        <li>
                            <a href="/liftapp/public/transmitting" class="fadeInUp animated">
                                <i class="fa fa-refresh fa-lg" aria-hidden="true"></i>
                                Прием заявок
                                <span></span></a>
                        </li>
                        <?php endif; ?>
                         ...
                         <li>
                            <a href="/liftapp/public/manager" class="fadeInUp animated">
                                <i class="fa fa-refresh fa-lg" aria-hidden="true"></i>
                                Менеджер
                                <span></span></a>
                        </li>
                        ...
                        <?php if(Auth::user()->role_id == '4'): ?>
                         <li>
                            <a href="/liftapp/public/supply" class="fadeInUp animated">
                                <i class="fa fa-refresh fa-lg" aria-hidden="true"></i>
                               Снабжение
                                <span></span></a>
                        </li>
